...
<?php
 ...
 if ( ! WC()->cart->is_empty() ) : ?>
	<div class="mini-cart-header"><?php echo __('Cart','olesia-child'); ?></div>
<div class="woocommerce-mini-cart cart_list product_list_widget prekesvisos">
		<?php
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<div class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<?php if ( empty( $product_permalink ) ) : ?>
						<?php echo $thumbnail . '<span>'.$product_name.'</span>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					<?php else : ?>
						<a href="<?php echo esc_url( $product_permalink ); ?>">
							<?php echo $thumbnail . '<span>'.$product_name.'</span>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</a>
					<?php endif; ?>
					<div class="product-price ctr2" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
							<?php
								echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); // PHPCS: XSS ok.
							?>
						</div>
					<div class="carttoprow2">
